...
(1100, '日志管理', 1000, 2, '/system/log', 'Log', 'system/log/index', NULL, 'icon-history', b'0', b'0', b'0', NULL, 7, 1, 1, NOW(), NULL, NULL),
...
(1120, '存储管理', 1000, 2, '/system/storage', 'Storage', 'system/storage/index', NULL, 'icon-storage', b'0', b'0', b'1', NULL, 8, 1, 1, NOW(), NULL, NULL),
