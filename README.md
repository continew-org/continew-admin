...
<img src="https://img.shields.io/badge/ContiNew Starter-2.2.0-%236CB52D.svg" alt="ContiNew Starter" />
</a>
...
| [ContiNew Starter](https://github.com/continew-org/continew-starter) | 2.2.0        | ContiNew Starter 包含了一系列经过企业实践优化的依赖包（如 MyBatis-Plus、SaToken），可轻松集成到应用中，为开发人员减少手动引入依赖及配置的麻烦，为 Spring Boot Web 项目的灵活快速构建提供支持。 |
