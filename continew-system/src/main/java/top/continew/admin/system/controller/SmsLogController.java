...
@Tag(name = "短信日志管理 API")
@RestController
@CrudRequestMapping(value = "/system/sms/log",
    api = {Api.PAGE, Api.GET, Api.BATCH_DELETE, Api.EXPORT})
public class SmsLogController
    extends BaseController<SmsLogService, SmsLogResp, SmsLogResp, SmsLogQuery, SmsLogReq> {
}
